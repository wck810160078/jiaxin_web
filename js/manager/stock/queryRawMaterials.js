...
//	        actionZoom:'',   //去除上传预览缩略图中的查看详情预览的缩略图标。
	...
	*/
    ...
    $('#outcome_id').click(function(){
		window.location.href = "http://127.0.0.1:8080/downloadStockInfo?label="+"原料" ;
    });
...
function uploadFile() {
	var formData = new FormData();
		...
		formData.append("label", "原料");//这个地方可以传递多个参数
		$.ajax({
